...
namespace operation {
    ...
    template <typename Range> struct range_tag_back_off<
    ...
    struct drop<mpl_sequence_tag, meta::front, Increment>
    {
        template <typename Range> struct apply
        {
            ...
            typedef
                typename mpl::advance<erase_begin, Increment>::type erase_end;

            typedef
                typename mpl::erase<Range, erase_begin, erase_end>::type type;
        };
    };
    template <typename Increment>
    struct drop<mpl_sequence_tag, meta::back, Increment>
    {
        template <typename Range> struct apply
        {
            ...
            typedef typename mpl::advance<
                erase_end, typename mpl::negate<Increment>::type>::type
                erase_begin;
