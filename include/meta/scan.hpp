...
struct range_tag<scan<Direction, Function, State, Range>> {
  ...
  // arguments.
  typedef scan_tag<typename scan<Direction, Function, State, Range>::direction>
      type;
};
...
// drop_one
template <typename Direction> struct drop_one<scan_tag<Direction>, Direction> {
  ...
  template <typename Scan> struct apply_not_empty {
    ...
    typedef typename mpl::apply<
        ...
        typename meta::first<Direction, typename Scan::range>::type>::type
        new_state;
