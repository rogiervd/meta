...
namespace operation {
    ...
    template <> struct fold<vector_tag, meta::front>
    {
        ...
        template <
            typename Function, typename State, typename Type1,
            typename... OtherTypes>
        ...
        template <
            typename Function, typename State, typename Type1, typename Type2,
            typename... OtherTypes>
        ...
        struct apply<
            Function, State, vector<Type1, Type2, Type3, OtherTypes...>>
        : apply<
              Function,
              typename mpl::apply<
                  Function,
...
template <typename Vector, typename Iterator> struct matching_iterator
: mpl::false_
{};
template <typename Vector, typename Position>
struct matching_iterator<Vector, vector_iterator<Position, Vector>> : mpl::true_
{};
...
: fold_reverse<Direction, push<front, mpl::_1, mpl::_2>, vector<>, Sequence>
{};
...
class tail_of_longer<meta::vector<Short...>, meta::vector<Long...>>
{
    ...
    */
    ...
    static meta::vector<After1, After...> return_after(
        vector_detail::swallow<Short> const &..., After1, After const &...);

    typedef decltype(return_after(
        vector_detail::wrap<Long>()...)) after_holders;
...
namespace boost { namespace mpl {
    ...
    template <> struct erase_impl<meta::vector_tag>
    {
        ...
        template <typename Vector, typename First, typename Last> struct apply
        {
            ...
            typedef typename boost::enable_if<
                matches, apply_one_c<Vector, First::index, Last>>::type::type
                type;
        };
        ...
        struct apply_one_c
        {
            ...
            static_assert(matches::value, "Iterator must match sequence");
            typedef typename boost::enable_if<
                matches, apply_range_c<Vector, first, Last::index>>::type::type
                type;
        };
        ...
        template <
            typename FirstType, typename... Types, std::size_t first,
            std::size_t last>
        struct apply_range_c<meta::vector<FirstType, Types...>, first, last>
        : meta::push<
              meta::front, FirstType,
              typename apply_range_c<
                  meta::vector<Types...>, first - 1, last - 1>::type>
        {};
    };
    ...
    template <> struct insert_impl<meta::vector_tag>
    {
        ...
        struct apply
        {
            ...
            static_assert(matches::value, "Iterator must match sequence");
            typedef typename boost::enable_if<
                matches, apply_c<Vector, Position::index, NewType>>::type::type
                type;
        };
        ...
        template <
            typename FirstType, typename... Types, std::size_t index,
            typename NewType>
        struct apply_c<meta::vector<FirstType, Types...>, index, NewType>
        : meta::push<
              meta::front, FirstType,
              typename apply_c<
                  meta::vector<Types...>, index - 1, NewType>::type>
        {};
    };
    ...
    template <> struct insert_range_impl<meta::vector_tag>
    {
        ...
        struct apply
        {
            ...
            static_assert(matches::value, "Iterator must match sequence");
            typedef typename boost::enable_if<
                matches, apply_c<Vector, Position::index, NewTypes>>::type::type
                type;
        };
        ...
        template <typename Vector, typename NewTypes> struct push_front_range<
            Vector, NewTypes, typename boost::enable_if<empty<NewTypes>>::type>
        {
            typedef Vector type;
        };

        template <typename Vector, typename NewTypes> struct push_front_range<
            Vector, NewTypes, typename boost::disable_if<empty<NewTypes>>::type>
        : meta::push<
              meta::front, typename mpl::front<NewTypes>::type,
        ...
        : meta::push<
              meta::front, FirstType,
              typename apply_c<
                  meta::vector<Types...>, index - 1, NewTypes>::type>
        {};
    };
    ...
    template <> struct end_impl<meta::vector_tag>
    {
        template <typename Vector> struct apply
        {
            typedef meta::vector_iterator<
                typename boost::mpl::size<Vector>::type, Vector>
                type;
        };
    };
    ...
    struct prior<meta::vector_iterator<Position, meta::vector<Types...>>>
    {
        ...
        typedef meta::vector_iterator<new_position, meta::vector<Types...>>
            type;
    };
    ...
    struct distance<
        ...
        meta::vector_iterator<Position2, Vector>> : minus<Position2, Position1>
    {};
