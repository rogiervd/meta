...
// Without Direction
template <class Limit, class Underlying> struct take<
    Limit, Underlying, typename boost::disable_if<is_direction<Limit>>::type>
...
struct range_tag<take<Direction, Limit, Underlying>>
{
    ...
    typedef take_tag<
        typename take_type::direction, typename take_type::underlying_tag>
        type;
};
...
namespace operation {
    ...
    struct empty<take_tag<Direction, UnderlyingTag>, Direction>
    {
        template <class Range> struct apply
        : mpl::or_<
              mpl::equal_to<typename Range::limit, mpl::size_t<0>>,
    ...
    struct drop<take_tag<Direction, UnderlyingTag>, Direction, Increment>
    {
        template <class Range> struct apply
        {
            typedef take<
                ...
                typename meta::drop<
                    Direction, Increment, typename Range::underlying>::type>
                type;
        };
    };
