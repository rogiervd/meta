...
template <class Direction, class Limit, class Underlying = void> struct take {
  typedef take type;
...
private:
  ...
  friend struct operation::empty<take_tag<Direction, underlying_tag>,
                                 Direction>;
  friend struct operation::size<take_tag<Direction, underlying_tag>, Direction>;
  friend struct operation::first<take_tag<Direction, underlying_tag>,
                                 Direction>;
...
struct range_tag<take<Direction, Limit, Underlying>> {
  ...
  typedef take_tag<typename take_type::direction,
                   typename take_type::underlying_tag>
      type;
};
...
struct empty<take_tag<Direction, UnderlyingTag>, Direction> {
  ...
  struct apply : mpl::or_<mpl::equal_to<typename Range::limit, mpl::size_t<0>>,
