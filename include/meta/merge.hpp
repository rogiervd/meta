...
struct left_first
    : mpl::apply<Compare, typename meta::first<Direction, Left>::type,
...
template <class Direction, class Compare, class Left, class Right>
struct merge
    : mpl::if_<mpl::and_<empty<Direction, Left>, empty<Direction, Right>>,
               merge_detail::empty_merge<Direction>,
               merge_detail::non_empty_merge<Direction, Compare, Left,
                                             Right>>::type {
...
struct range_tag<merge<Direction, Compare, Left, Right>> {
  typedef merge_tag<typename merge<Direction, Compare, Left, Right>::direction>
      type;
};
  ...
  template <class Range> struct apply {
    typedef merge<
        ...
        typename mpl::eval_if<
            ...
            meta::drop<typename Range::direction, typename Range::right>,
