...
template <typename Direction, typename Predicate, typename Range1 = void,
...
struct equal<Predicate, Range1, Range2,
    ...
    : equal<typename default_direction<Range1>::type, Predicate, Range1,
            Range2> {};
...
template <typename Direction, typename Predicate, typename Range1,
          typename Range2>
struct equal_impl
    : mpl::eval_if<typename mpl::apply<
                       Predicate, typename first<Direction, Range1>::type,
                       typename first<Direction, Range2>::type>::type,
                   equal<Direction, typename drop<Direction, Range1>::type,
