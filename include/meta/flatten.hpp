...
namespace flatten_detail {
    ...
    template <
        typename Direction, typename Sequences,
    ...
    : fold<Direction, meta::concatenate<mpl::_, mpl::_>, Sequences>
    {};

}  // namespace flatten_detail

template <typename Direction, typename Sequences> struct flatten
