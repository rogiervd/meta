...
struct range_tag : operation::range_tag_back_off<Range> {};
...
struct default_direction
    : operation::default_direction<
          typename range_tag<Range>::type>::template apply<Range> {};
...
struct empty : operation::empty<typename range_tag<Range>::type,
                                Direction>::template apply<Range> {};
...
// Forward to operation
template <typename Direction, typename Range>
struct size : operation::size<typename range_tag<Range>::type,
                              Direction>::template apply<Range> {};
...
// Forward to operation
template <typename Direction, typename Range>
struct first : operation::first<typename range_tag<Range>::type,
                                Direction>::template apply<Range> {};
...
Direction.
*/
template <typename DirectionOrNumberOrRange, typename NumberOrRange = void,
          typename Range = void>
struct drop;
...
struct drop<Number, Range,
            typename boost::enable_if<mpl::and_<mpl::not_<is_direction<Number>>,
                                                is_range<Range>>>::type>
    : drop<typename default_direction<Range>::type, Number, Range> {};

template <typename Direction, typename Number, typename Range>
struct drop : operation::drop<typename range_tag<Range>::type, Direction,
                              Number>::template apply<Range> {};
...
struct push : operation::push<typename range_tag<Range>::type,
                              Direction>::template apply<NewElement, Range> {};
...
template <class NewElement, class Range>
struct insert<NewElement, Range>
    : insert<typename default_direction<Range>::type, NewElement, Range> {};

template <class Direction, class NewElement, class Range>
struct insert
    : operation::insert<typename range_tag<Range>::type,
                        Direction>::template apply<NewElement, Range> {};
...
template <class Key, class Range>
struct at
    : operation::at<typename range_tag<Range>::type>::template apply<Key,
                                                                     Range> {};
...
template <class Key, class Range>
struct remove
    : operation::remove<typename range_tag<Range>::type>::template apply<
          Key, Range> {};
...
struct drop_general {
  ...
  */
  template <typename Range>
  struct apply : meta::drop<Direction,
                            typename drop_general<Tag, Direction, number - 1>::
                                template apply<Range>::type> {};
...
struct drop : drop_general<Tag, Direction, Number::value> {};

/**
Default implementation: try to forward to drop.
*/
template <typename Tag, typename Direction>
struct drop_one : drop<Tag, Direction, mpl::size_t<1>> {};
