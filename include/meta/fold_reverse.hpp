...
struct fold_reverse<Function, State, Range,
                    typename boost::disable_if<is_direction<Function>>::type>
    : fold_reverse<typename default_direction<Range>::type, Function, State,
                   Range> {};
...
struct fold_reverse<Direction, Function, Range,
    ...
    : operation::fold_reverse_1<typename range_tag<Range>::type,
                                Direction>::template apply<Function, Range> {};
