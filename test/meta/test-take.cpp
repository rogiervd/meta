...
BOOST_AUTO_TEST_CASE(test_meta_take) {
...

  {
    ...
    BOOST_MPL_ASSERT((mpl::equal_to<meta::size<empty_list>, mpl::size_t<0>>));
  }
  ...
  {
    typedef meta::take<meta::list_direction, mpl::int_<2>,
                       meta::weird_list<int, double, bool>>
        list;

    BOOST_MPL_ASSERT_NOT((meta::empty<meta::list_direction, list>));
    BOOST_MPL_ASSERT((
        mpl::equal_to<meta::size<meta::list_direction, list>, mpl::size_t<2>>));
    BOOST_MPL_ASSERT(
        (std::is_same<meta::first<meta::list_direction, list>::type, int>));

    typedef meta::drop<meta::list_direction, list>::type list_1;
    BOOST_MPL_ASSERT_NOT((meta::empty<meta::list_direction, list_1>));
    BOOST_MPL_ASSERT((mpl::equal_to<meta::size<meta::list_direction, list_1>,
                                    mpl::size_t<1>>));
    BOOST_MPL_ASSERT((
        std::is_same<meta::first<meta::list_direction, list_1>::type, double>));

    typedef meta::drop<meta::list_direction, list_1>::type empty_list;
    BOOST_MPL_ASSERT((meta::empty<meta::list_direction, empty_list>));
    BOOST_MPL_ASSERT(
        (mpl::equal_to<meta::size<meta::list_direction, empty_list>,
                       mpl::size_t<0>>));
  ...
  {
    typedef meta::take<meta::list_direction, mpl::int_<3>,
                       meta::weird_list<int, double>>
        list;
