...
typedef map<map_element<bool, bool_value>, map_element<int, int_value>> map_2;
...
BOOST_AUTO_TEST_CASE(test_meta_map) {
  ...
  // size.
  BOOST_MPL_ASSERT(
      (boost::mpl::equal<meta::size<map_0>, boost::mpl::size_t<0>>));
  BOOST_MPL_ASSERT(
      (boost::mpl::equal<meta::size<map_1>, boost::mpl::size_t<1>>));
  BOOST_MPL_ASSERT(
      (boost::mpl::equal<meta::size<map_2>, boost::mpl::size_t<2>>));

  // first.
  BOOST_MPL_ASSERT((std::is_same<typename meta::first<map_1>::type,
                                 map_element<int, int_value>>));
  BOOST_MPL_ASSERT((std::is_same<typename meta::first<map_2>::type,
                                 map_element<bool, bool_value>>));

  // drop.
  BOOST_MPL_ASSERT((std::is_same<typename meta::drop<map_1>::type, map_0>));
  BOOST_MPL_ASSERT((std::is_same<typename meta::drop<map_2>::type, map_1>));
  ...
  BOOST_MPL_ASSERT((std::is_same<meta::at<bool, map_2>::type, bool_value>));
  ...
  BOOST_MPL_ASSERT((
      std::is_same<typename meta::insert<map_element<bool, void>, map_2>::type,
                   map<map_element<bool, void>, map_element<int, int_value>>>));

  // remove.
  BOOST_MPL_ASSERT(
      (std::is_same<typename meta::remove<int, map_1>::type, map_0>));
  BOOST_MPL_ASSERT(
      (std::is_same<typename meta::remove<bool, map_2>::type, map_1>));
  BOOST_MPL_ASSERT((std::is_same<typename meta::remove<int, map_2>::type,
