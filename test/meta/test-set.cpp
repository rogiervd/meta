...
BOOST_AUTO_TEST_CASE(test_meta_set) {
  ...
  // size.
  BOOST_MPL_ASSERT(
      (boost::mpl::equal<meta::size<set_0>, boost::mpl::size_t<0>>));
  BOOST_MPL_ASSERT(
      (boost::mpl::equal<meta::size<set_1>, boost::mpl::size_t<1>>));
  BOOST_MPL_ASSERT(
      (boost::mpl::equal<meta::size<set_2>, boost::mpl::size_t<2>>));

  // first.
  BOOST_MPL_ASSERT((std::is_same<typename meta::first<set_1>::type, int>));
  BOOST_MPL_ASSERT((std::is_same<typename meta::first<set_2>::type, bool>));

  // drop.
  BOOST_MPL_ASSERT((std::is_same<typename meta::drop<set_1>::type, set_0>));
  BOOST_MPL_ASSERT((std::is_same<typename meta::drop<set_2>::type, set_1>));

  // push.
  BOOST_MPL_ASSERT(
      (std::is_same<typename meta::push<int, set_0>::type, set_1>));
  BOOST_MPL_ASSERT(
      (std::is_same<typename meta::push<bool, set_1>::type, set_2>));
  ...
  // insert: new element.
  BOOST_MPL_ASSERT(
      (std::is_same<typename meta::insert<int, set_0>::type, set_1>));
  BOOST_MPL_ASSERT(
      (std::is_same<typename meta::insert<bool, set_1>::type, set_2>));
  // Existing element.
  BOOST_MPL_ASSERT(
      (std::is_same<typename meta::insert<int, set_1>::type, set_1>));
  BOOST_MPL_ASSERT(
      (std::is_same<typename meta::insert<int, set_2>::type, set_2>));
  BOOST_MPL_ASSERT(
      (std::is_same<typename meta::insert<bool, set_2>::type, set_2>));

  // remove.
  BOOST_MPL_ASSERT(
      (std::is_same<typename meta::remove<int, set_1>::type, set_0>));
  BOOST_MPL_ASSERT(
      (std::is_same<typename meta::remove<bool, set_2>::type, set_1>));
}
...
BOOST_AUTO_TEST_CASE(test_meta_as_set) {
  ...
  {
    BOOST_MPL_ASSERT((std::is_same<typename meta::as_set<meta::vector<>>::type,
                                   meta::set<>>));
    BOOST_MPL_ASSERT(
        (std::is_same<typename meta::as_set<meta::vector<int>>::type,
                      meta::set<int>>));
    BOOST_MPL_ASSERT(
        (std::is_same<typename meta::as_set<meta::vector<int, bool>>::type,
                      meta::set<int, bool>>));

    // Duplicate elements are represented only once.
    BOOST_MPL_ASSERT(
        (std::is_same<typename meta::as_set<meta::vector<int, bool, int>>::type,
                      meta::set<bool, int>>));
    BOOST_MPL_ASSERT(
        (std::is_same<
...
BOOST_AUTO_TEST_CASE(test_meta_is_subset) {
  ...
  static_assert(meta::is_subset<meta::set<int>, meta::set<int>>::value, "");

  static_assert(meta::is_subset<meta::set<>, meta::set<bool>>::value, "");
  static_assert(!meta::is_subset<meta::set<int>, meta::set<bool>>::value, "");
  static_assert(meta::is_subset<meta::set<>, meta::set<int, bool>>::value, "");
  static_assert(meta::is_subset<meta::set<int>, meta::set<bool, int>>::value,
                "");

  static_assert(meta::is_subset<meta::set<bool>, meta::set<bool>>::value, "");
  static_assert(!meta::is_subset<meta::set<int, bool>, meta::set<bool>>::value,
                "");
  static_assert(meta::is_subset<meta::set<bool>, meta::set<int, bool>>::value,
                "");
  static_assert(
      meta::is_subset<meta::set<int, bool>, meta::set<bool, int>>::value, "");

  static_assert(
      meta::is_subset<meta::set<bool, float>, meta::set<bool, float>>::value,
      "");
