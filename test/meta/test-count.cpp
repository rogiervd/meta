...
BOOST_AUTO_TEST_CASE(test_meta_count) {
  ...
  BOOST_MPL_ASSERT(
      (std::is_same<meta::count<1>::type,
                    meta::vector<std::integral_constant<std::size_t, 0>>>));
  BOOST_MPL_ASSERT(
      (std::is_same<meta::count<2>::type,
                    meta::vector<std::integral_constant<std::size_t, 0>,
                                 std::integral_constant<std::size_t, 1>>>));
  BOOST_MPL_ASSERT(
      (std::is_same<meta::count<4>::type,
                    meta::vector<std::integral_constant<std::size_t, 0>,
                                 std::integral_constant<std::size_t, 1>,
  ...
  BOOST_MPL_ASSERT(
      (std::is_same<meta::count<0, 1>::type,
                    meta::vector<std::integral_constant<std::size_t, 0>>>));
  BOOST_MPL_ASSERT(
      (std::is_same<meta::count<7, 8>::type,
                    meta::vector<std::integral_constant<std::size_t, 7>>>));

  BOOST_MPL_ASSERT(
      (std::is_same<meta::count<0, 2>::type,
                    meta::vector<std::integral_constant<std::size_t, 0>,
                                 std::integral_constant<std::size_t, 1>>>));
  BOOST_MPL_ASSERT(
      (std::is_same<meta::count<10, 12>::type,
                    meta::vector<std::integral_constant<std::size_t, 10>,
                                 std::integral_constant<std::size_t, 11>>>));

  BOOST_MPL_ASSERT(
      (std::is_same<meta::count<0, 4>::type,
                    meta::vector<std::integral_constant<std::size_t, 0>,
                                 std::integral_constant<std::size_t, 1>,
                                 std::integral_constant<std::size_t, 2>,
                                 std::integral_constant<std::size_t, 3>>>));
  BOOST_MPL_ASSERT(
      (std::is_same<meta::count<17, 21>::type,
                    meta::vector<std::integral_constant<std::size_t, 17>,
