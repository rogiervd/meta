...
BOOST_AUTO_TEST_CASE(test_meta_index_contains) {
  ...
  {
    typedef index<key_entry<int>, key_entry<double>, key_entry<void>,
                  key_entry<short>>
        i;
...
BOOST_AUTO_TEST_CASE(test_meta_index_remove) {
...

  {
    ...
    static_assert(std::is_same<remove<int, i>::type, index<>>::value, "");
  }
  {
    typedef index<key_entry<int>, key_entry<double>> i;

    static_assert(
        std::is_same<remove<int, i>::type, index<key_entry<double>>>::value,
        "");
    static_assert(
        std::is_same<remove<double, i>::type, index<key_entry<int>>>::value,
        "");
  }
  {
    typedef index<key_entry<int>, key_entry<double>, key_entry<void>,
    ...
    static_assert(
        std::is_same<
            remove<int, i>::type,
            index<key_entry<double>, key_entry<void>, key_entry<short>>>::value,
        "");
    static_assert(
        std::is_same<
            remove<double, i>::type,
            index<key_entry<int>, key_entry<void>, key_entry<short>>>::value,
        "");
    static_assert(
        std::is_same<
            remove<void, i>::type,
            index<key_entry<int>, key_entry<double>, key_entry<short>>>::value,
        "");
    static_assert(
        std::is_same<
            remove<short, i>::type,
            index<key_entry<int>, key_entry<double>, key_entry<void>>>::value,
        "");
  }
}
...
BOOST_AUTO_TEST_CASE(test_meta_index_insert) {
  ...
  }
  {
    ...
    static_assert(std::is_same<insert<key_value<int, bool>, i>::type,
                               index<key_value<int, bool>, key_entry<bool>,
                                     key_entry<void>>>::value,
                  "");
  }
  ...
  }
  {
    ...
    static_assert(
        std::is_same<insert<key_value<int, void>, i>::type,
                     index<key_value<int, void>, key_entry<double>>>::value,
        "");
    static_assert(
        std::is_same<insert<key_value<double, void>, i>::type,
  ...
  }
  {
    ...
    static_assert(std::is_same<insert<key_value<int, char>, i>::type,
                               index<key_value<int, char>, key_entry<double>,
                                     key_entry<void>, key_entry<short>>>::value,
                  "");
    static_assert(std::is_same<insert<key_value<double, char>, i>::type,
                               index<key_value<double, char>, key_entry<int>,
                                     key_entry<void>, key_entry<short>>>::value,
                  "");
    static_assert(
        std::is_same<insert<key_value<void, char>, i>::type,
                     index<key_value<void, char>, key_entry<int>,
                           key_entry<double>, key_entry<short>>>::value,
        "");
    static_assert(
        std::is_same<insert<key_value<short, char>, i>::type,
                     index<key_value<short, char>, key_entry<int>,
                           key_entry<double>, key_entry<void>>>::value,
        "");
  }
}
