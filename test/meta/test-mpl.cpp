...
BOOST_AUTO_TEST_CASE(test_meta_mpl_intrinsic)
{
    ...
    BOOST_MPL_ASSERT(
        (std::is_same<meta::first<meta::back, vector1>::type, int>) );
    BOOST_MPL_ASSERT(
    ...
    BOOST_MPL_ASSERT(
        (meta::equal<meta::drop<vector2>::type, mpl::vector<bool>>) );
    BOOST_MPL_ASSERT(
        (meta::equal<
    ...
    BOOST_MPL_ASSERT(
        (meta::equal<
            meta::push<meta::back, long, vector0>::type, mpl::vector<long>>) );
    BOOST_MPL_ASSERT((meta::equal<
    ...
    BOOST_MPL_ASSERT((std::is_same<
                      meta::fold<
                          meta::push<mpl::_2, mpl::_1>, meta::vector<>,
                          mpl::vector<int, bool>>::type,
                      meta::vector<bool, int>>) );
    BOOST_MPL_ASSERT((std::is_same<
                      meta::fold<
                          meta::back, meta::push<mpl::_2, mpl::_1>,
    ...
    BOOST_MPL_ASSERT((std::is_same<
                      meta::fold<
                          meta::push<mpl::_2, mpl::_1>, meta::vector<int>,
                          mpl::vector<>>::type,
                      meta::vector<int>>) );
    BOOST_MPL_ASSERT((std::is_same<
                      meta::fold<
