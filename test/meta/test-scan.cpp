...
BOOST_AUTO_TEST_CASE(test_meta_scan) {
  ...
  typedef meta::scan<meta::push<mpl::_2, mpl::_1>, void, list0> list_void;
  typedef meta::scan<meta::push<mpl::_2, mpl::_1>, meta::list<>, list4>
      list_list;
  ...
  */
  ...
  BOOST_MPL_ASSERT(
      (boost::mpl::equal_to<meta::size<list_void>, boost::mpl::size_t<1>>));
  ...
  BOOST_MPL_ASSERT(
      (boost::mpl::equal_to<meta::size<meta::drop<list_void>::type>,
                            boost::mpl::size_t<0>>));

  // list_list.
  BOOST_MPL_ASSERT_NOT((meta::empty<list_list>::type));
  BOOST_MPL_ASSERT(
      (boost::mpl::equal_to<meta::size<list_list>, boost::mpl::size_t<5>>));

  BOOST_MPL_ASSERT((is_same<meta::first<list_list>::type, meta::list<>>));
  BOOST_MPL_ASSERT((is_same<meta::first<meta::drop<list_list>::type>::type,
                            meta::list<int>>));
  BOOST_MPL_ASSERT(
      (is_same<meta::first<meta::drop<mpl::size_t<2>, list_list>::type>::type,
               meta::list<bool, int>>));
  BOOST_MPL_ASSERT(
      (is_same<meta::first<meta::drop<mpl::size_t<3>, list_list>::type>::type,
               meta::list<float, bool, int>>));
  BOOST_MPL_ASSERT(
      (is_same<meta::first<meta::drop<mpl::size_t<4>, list_list>::type>::type,
               meta::list<double, float, bool, int>>));
  BOOST_MPL_ASSERT((meta::empty<meta::drop<mpl::size_t<5>, list_list>::type>));
  ...
  typedef meta::scan<meta::list_direction,
                     meta::push<meta::list_direction, mpl::_2, mpl::_1>, void,
                     list0>
      dir_list_void;
  typedef meta::scan<meta::list_direction,
  ...
  BOOST_MPL_ASSERT((is_same<meta::first<dir_list_list>::type, meta::list<>>));
  BOOST_MPL_ASSERT((is_same<meta::first<meta::drop<dir_list_list>::type>::type,
                            meta::list<int>>));
  BOOST_MPL_ASSERT(
      (is_same<
  ...
  BOOST_MPL_ASSERT(
      (is_same<
          ...
          meta::list<double, float, bool, int>>));
  BOOST_MPL_ASSERT(
      (meta::empty<meta::drop<mpl::size_t<5>, dir_list_list>::type>));
  ...
  BOOST_MPL_ASSERT(
      (is_same<meta::first<weird_list_list>::type, meta::weird_list<>>));
  BOOST_MPL_ASSERT(
      (is_same<meta::first<meta::drop<weird_list_list>::type>::type,
               meta::weird_list<int>>));
  BOOST_MPL_ASSERT(
      (is_same<
  ...
  BOOST_MPL_ASSERT(
      (meta::empty<meta::drop<mpl::size_t<5>, weird_list_list>::type>));
}
