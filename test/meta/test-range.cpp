...
BOOST_AUTO_TEST_CASE(test_meta_range) {
  ...
  BOOST_MPL_ASSERT((is_same<drop<dir, weird_list1>::type, meta::weird_list<>>));
  BOOST_MPL_ASSERT((is_same<drop<dir, weird_list4>::type,
                            meta::weird_list<bool, float, double>>));

  // drop
  BOOST_MPL_ASSERT(
      (is_same<drop<mpl::size_t<2>, list4>::type, meta::list<float, double>>));
  ...
  BOOST_MPL_ASSERT((
      is_same<drop<dir, mpl::int_<4>, weird_list4>::type, meta::weird_list<>>));

  // push
  BOOST_MPL_ASSERT((is_same<push<long, list0>::type, meta::list<long>>));
  BOOST_MPL_ASSERT((is_same<push<long, list1>::type, meta::list<long, int>>));
  BOOST_MPL_ASSERT((is_same<push<long, list4>::type,
                            meta::list<long, int, bool, float, double>>));

  BOOST_MPL_ASSERT((is_same<push<dir, long, list0>::type, meta::list<long>>));
  BOOST_MPL_ASSERT(
